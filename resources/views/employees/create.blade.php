    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="card">
                ...
                {{-- Data form dikirim ke EmployeeController@store. --}}
                <form action="{{ route('employees.store') }}" method="POST">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    @foreach ($jobs as $job)
                                        <option
                                            value="{{ $job->job_id }}"
                                            @selected(old('job_id') == $job->job_id)
                                        >
                                ...
                                >
                                    ...
                                    @foreach ($managers as $manager)
                                        <option
                                            ...
                                            @selected(old('manager_id') == $manager->employee_id)
                                        >
                        ...
                        <div class="form-text mt-3">
                            Employee ID dibuat otomatis oleh aplikasi berdasarkan ID terakhir pada database.
                        </div>
                    </div>
